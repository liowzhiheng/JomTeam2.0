...
export interface MatchFilters { query?: string; sport?: string; location?: string; skillLevel?: string; date?: string; status?: string; sort?: 'soonest' | 'newest'; page: number; pageSize: number; }
